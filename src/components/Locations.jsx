  ...
  const locations = [
    {
      ...
      established: "1950",
      constructionInfo:
        "Pune has a booming real estate sector, with a focus on both residential and commercial projects. Many high-rise buildings and IT parks are being developed.",
    },
    {
      city: "Noida",
      description:
      ...
      established: "1997",
      constructionInfo:
        "Noida is witnessing rapid growth in residential complexes, tech parks, and infrastructure projects, making it a key hub for construction and real estate investment.",
    },
    {
      city: "Bangalore",
      description:
      ...
      established: "1537",
      constructionInfo:
        "Bangalore is a hotspot for commercial real estate, with a focus on tech parks and mixed-use developments. The city’s infrastructure is constantly evolving to meet the demands of its growing population.",
    },
  ];
        ...
        {locations.map((location, index) => (
          <div key={index} className="location-card" style={cardStyle}>
            ...
            <div style={additionalDataStyle}>
              ...
              <p>
                <strong>Construction Focus:</strong> {location.constructionInfo}
              </p>
            </div>
          </div>
        ))}
